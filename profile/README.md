...
**Agentes IA · Contenido viral · Trading autónomo · Webs SMB profesionales.**
...
| | Pilar | Qué hacemos |
|---|---|---|
| 🤖 | **AI Agents** | Agentes IA autónomos a medida, integrados con tus sistemas. Sin lock-in, sin caja negra. |
| 📹 | **Virals** | Pipelines de contenido viral generado y optimizado por IA. De 1 long-form a N piezas multi-plataforma. |
...
1. **Sin humo IA.** Construimos sistemas que funcionan, que decides tú, y que son tuyos.
2. **Sin lock-in.** Todo el código entregado a clientes es de su propiedad. Filosofía portable.
3. **OpenSource first.** Lo que pueda ser público, lo es. Devolvemos al ecosistema.
4. **Karpathy principles** — Think before coding · Simplicity · Surgical changes · Goal-driven.
5. **Revenue-first.** Generamos valor real antes de construir infraestructura especulativa.
...
Agentes a medida, pipelines de contenido, automatización de procesos.
...
- **HQ**: Coves de Vinromà, Castellón, España 🇪🇸
- **Founder**: [Jonatan García Ripollés](https://www.linkedin.com/in/jonatan-garcia-ripolles/) — Ingeniero industrial + AI Engineer
- **Operación**: 100% remoto / mundo
...
Repositorios públicos: **MIT** salvo indicación explícita.
Repositorios privados: propiedad de NeoNexAI Agency.

<div align="center">

_Hecho con Claude Code, Astro, agentes IA y mucho café en Castellón._
