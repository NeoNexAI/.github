...
¿Necesitas ayuda con un proyecto de **NeoNexAI**? Estás en el sitio correcto.
_Need help with a **NeoNexAI** project? You're in the right place._
...
|---|---|
| 🐛 **Bug** en un repo | Abre un [issue](https://github.com/neonexai) con la plantilla de _Bug report_ |
...
1. Busca en los [issues existentes](https://github.com/neonexai) por si ya está reportado.
2. Revisa el README y la documentación del repositorio.
3. Incluye toda la información posible (versión, pasos, logs, capturas).

### Tiempos de respuesta

Somos un equipo pequeño. Hacemos lo posible por responder los issues en **2-5 días laborables**. Para clientes con contrato de soporte, aplican los SLA acordados.
